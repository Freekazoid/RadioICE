  ...
  <div class="team">
    ...
    <div class="wrapper">
      ...
      <div class="newIemsList" v-if="!moreInfos">
        <div v-for="item in command" :key="item.id" class="imagesBlock" :class="item.hover ? 'activeNewItems' : ''" @mouseenter="activeSlideNewItems(item)">
          <div class="imagesBackSelect"></div>
          <div class="images"><GetImages :img="`commands/${item.img}`" /></div>
      ...
      <div class="newIemsMore" v-else>
        <div class="content">
          <div class="box">
            <div class="images">
              <GetImages :img="`commands/${onliRead.img}`" class="images" />
            </div>
            <div class="name">
              {{ onliRead.name }}
            </div>
